...
def parse_date(text):
    ...
    # Определяем текущий год, месяц и день
    year = current_date.year
    current_month = current_date.month
    current_day = current_date.day

    # Словарь для числовых представлений месяцев
    numeric_months = {
        1: 'января',
        2: 'февраля',
        3: 'марта',
    ...
    # Список названий дней недели для определения числа дня недели
    weekdays = {
        "понедельник": 0,
        "вторник": 1,
        "среда": 2,
    ...
    # Регулярное выражение для поиска дня недели и месяца
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Parse date from text")
